...
const previewTargets = [
  { indicatorId: 3, targetValue: 20 },
  { indicatorId: 4, targetValue: 8 },
];

const previewResults = [
  { id: 101, indicatorId: 3, actualValue: 14, progressRate: 70, status: "draft", selfEvaluation: "" },
];
    ...
    <div className="space-y-6">
      ...
      {usingPreviewData && (
        <div className="rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          로컬 preview용 예시 데이터입니다. API 및 데이터베이스 연결 후 실제 프로그램 실적으로 대체됩니다.
        </div>
      )}
